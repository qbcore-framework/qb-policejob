local Translations = {
    ...
    info = {
        ...
        on_duty = '[~g~E~s~] - Entrar em serviço',
        off_duty = '[~r~E~s~] - Sair de serviço',
        onoff_duty = '~g~Em~s~/~r~Fora de~s~ Serviço',
        stash = 'Baú %{value}',
        delete_spike = '[~r~E~s~] Remover Tira de Espigões',
        close_camera = 'Fechar Câmera',
        bullet_casing = '[~g~G~s~] Invólucro de Bala %{value}',
        ...
        take_heli = '[~g~E~s~] Pedir Helicóptero',
        impound_veh = '[~g~E~s~] - Apreender Veículo',
        store_veh = '[~g~E~s~] - Guardar Veículo',
        armory = 'Arsenal',
        enter_armory = '[~g~E~s~] Arsenal',
        finger_scan = 'Digitalizar Impressão Digital',
        scan_fingerprint = '[~g~E~s~] Digitalizar Impressão Digital',
        trash = 'Lixo',
        trash_enter = '[~g~E~s~] Lixo',
        stash_enter = '[~g~E~s~] Abrir Cacifo',
