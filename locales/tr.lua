local Translations = {
    ...
    info = {
        ...
        fine_issued = 'Suçluya başarılı bir şekilde ceza kesildi',
        received_fine = 'Devlet Borç Tahsilatı, borçlu olunan cezaları otomatik olarak tahsil etmiştir...'
    },
    evidence = {
