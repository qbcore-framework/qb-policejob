local Translations = {
    ...
    success = {
        ...
        impound_vehicle_removed = 'Le véhicule a été sorti de la fourrière!',
    },
    info = {
        mr = 'Mr.',
        mrs = 'Mme.',
        ...
        poobject_object = 'Type d\'objet à faire apparaître \'supprimer\' à supprimer',
        ...
        target_location = 'La position de %{firstname} %{lastname} a été marquée sur votre carte.',
