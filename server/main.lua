...
AddEventHandler('police:server:checkFines', function(playerId)
	...
	exports.ghmattimysql:executeSync(false, "SELECT * FROM phone_invoices WHERE `citizenid` = '"..SearchedPlayer.PlayerData.citizenid.."' AND `society`='police'", function(invoices) 
            if #invoices == 0 then
