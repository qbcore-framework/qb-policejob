...
RegisterNetEvent('police:server:FlaggedPlateTriggered', function(camId, plate, street1, street2, coords)
    local src = source
        ...
        if Player then
            if (Player.PlayerData.job.name == "police" and Player.PlayerData.job.onduty) then
                if street2 then
                    ...
                    message = "Cam: "..camId.." Plate: "..plate.." At: "..streetLabel
                    TriggerClientEvent("police:client:policeAlert", v, coords, message)
                else
                    streetLabel = street1
                    message = "Cam: "..camId.." Plate: "..plate.." At: "..streetLabel
                    TriggerClientEvent("police:client:policeAlert", v, coords, message)
